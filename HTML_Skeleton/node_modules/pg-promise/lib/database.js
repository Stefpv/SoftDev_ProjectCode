...
function Database(cn, dc, config) {
    ...
    function extend(ctx, obj) {
         ...
         * @description
         * Executes a database function as `SELECT * FROM funcName(values)`.
         *
         * This is to help with the most common scenario of using functions.
         * If, however, you need to type-cast parameters, or use the `SELECT funcName` form,
         * then you should use a regular query method.
         *
        ...
        obj.proc = function (procName, values) {
            return obj.query.call(this, {entity: procName, type: 'proc'}, values, queryResult.none);
        };
